...
parser.add_argument("--R_smooth", type=float, default=5.0,
                    help="Smoothing in Mpc/h (default 5.0, coerente con DESI voxelize)")
...
CHAINS_DIR  = RES_DIR / "phase6_mock_chains_z05"
MANIFEST    = RES_DIR / "phase6_mock_manifest_z05.json"
OUTPUT_Z05  = RES_DIR / "phase6_mock_features_z05.npz"
